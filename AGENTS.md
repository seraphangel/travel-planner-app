...
AI-powered travel planning app that researches destinations, builds daily itineraries, and charges for access via a paid subscription tier.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "792511+seraphangel@users.noreply.github.com"
  git config user.name "seraphangel"
  ```
